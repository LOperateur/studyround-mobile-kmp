    ...
    private fun SignupFormContent() {
        Column(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                val linkStyle = SpanStyle(color = StudyRoundTheme.colors.primary2)
                ...
                ClickableText(
                    ...
                    onClick = { offset ->
                        annotatedTermsAndPolicy.getStringAnnotations(
                            ...
                            Logger.d(tag = "terms URL", messageString = it.item)
                        }
                        ...
                        annotatedTermsAndPolicy.getStringAnnotations(
                            ...
                            Logger.d(tag = "policy URL", messageString = it.item)
                        }
                    }
                )
            }
